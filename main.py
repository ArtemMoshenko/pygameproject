...
class Board:
    ...
    def constant(self, width, height, screen, left=10, top=10):
        ...
        self.button_tank = (self.right_kray + 50, 250, 50, 50)
        self.button_sold = (self.right_kray + 50, 330, 50, 50)
        self.button_turn = (self.right_kray + 50, 170, 120, 50)
        self.button_supertank = (self.right_kray + 50, 410, 50, 50)
        self.button_turn_text = (self.right_kray + 50, 185)
        ...
        self.income2 = 0
        self.base1 = (0, 0)
        self.base2 = (width - 1, height - 1)

        self.sold_price = 400
        self.tank_price = 200
        self.supertank_price = 800
    ...
    def draw_income(self):
        self.screen.fill("black", (*self.income_xy, 250, 40))

        if self.turn == 0:
            text = myfont.render('Доход: ' + str(self.income1), False, (0, 0, 255))
        else:
            text = myfont.render('Доход: ' + str(self.income2), False, (255, 0, 0))
    ...
    def load_sound(self):
        ...
        # self.sound_music.set_volume(0.1)
    ...
    def buttons(self):
        ...
        self.screen.fill("blue", self.button_sold)
        self.screen.fill("blue", self.button_tank)
        self.screen.fill("blue", self.button_supertank)
    ...
    def draw_fire(self, x, y):
        ...
        self.effect_sprites.add(self.fire_sprite)
    ...
    def change_turn(self):
        ...
        print(self.income1, self.income2)
        ...
        self.screen.fill("black", (*self.text_xy, 250, 40))
        if self.turn == 0:
    ...
    def draw_money(self):
        self.screen.fill("black", (*self.money_xy, 200, 40))
...
class Soldier(Unit):
    def __init__(self, x, y, turn):
        ...
        self.type = 2
        if self.player == 1:
            self.image = pygame.image.load("blue_soldier.png")
            self.image = pygame.transform.scale(self.image, (40, 40))
        else:
            self.image = pygame.image.load("red_soldier.png")
            self.image = pygame.transform.scale(self.image, (40, 40))
...
class SuperTank(Unit):
    def __init__(self, x, y, turn):
        super().__init__(x, y, turn)
        self.type = 3
        if self.player == 1:
            self.image = pygame.image.load("Supertank.png")
            self.image = pygame.transform.scale(self.image, (40, 40))
        else:
            self.image = pygame.image.load("Supertank.png")
            self.image = pygame.transform.scale(self.image, (40, 40))
                        ...
                        if board.show_m:
                            ...
                            if board.check_place(x, y):
                                if board.place_m == 1:
                                    ...
                                    board.add_unit(SuperTank(x, y, board.turn))
                                    # другие юниты
                                board.hide_moves()
