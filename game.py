...
def game(mode):
  ...
  class Board:
      ...
      def create_fire_sprite(self):
        self.fire_image = pygame.image.load("sprites/fire.png")
      ...
      def load_sound(self):
          self.sound_shot = pygame.mixer.Sound('sound/shot.mpeg')
          self.sound_music=pygame.mixer.Sound('sound/music.mpeg')
  ...
  class Tank(Unit):
      def __init__(self, x, y, turn,can_move=1,has_hp=0):
          ...
          self.type = 1
          if self.player == 1:
              self.image = pygame.image.load("sprites/blue_shot_0.png")
              self.image = pygame.transform.scale(self.image, (40, 40))
          else:
              self.image = pygame.image.load("sprites/red_shot_0.png")
              self.image = pygame.transform.scale(self.image, (40, 40))
  ...
  class Soldier(Unit):
      def __init__(self, x, y, turn,can_move=1,has_hp=0):
          ...
          self.type = 2
          if self.player == 1:
              self.image = pygame.image.load("sprites/soldier_blue_0.png")
              self.image = pygame.transform.scale(self.image, (20, 40))
          else:
              self.image = pygame.image.load("sprites/soldier_red_0.png")
              self.image = pygame.transform.scale(self.image, (20, 40))
  ...
  class Trak(Unit):
      def __init__(self, x, y, turn,can_move=1,has_hp=0):
          ...
          self.type = 3
          if self.player == 1:
              self.image = pygame.image.load("sprites/tractor_blue_0.png")
              self.image = pygame.transform.scale(self.image, (40, 40))
          else:
              self.image = pygame.image.load("sprites/tractor_red_0.png")
              self.image = pygame.transform.scale(self.image, (40, 40))
